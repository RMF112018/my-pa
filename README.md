...
in which 94 of the 164 capabilities are `available` and 70 — the six `documents.`
...
`70 of 164 capabilities are unwired.` Derived by building the manifest both ways
