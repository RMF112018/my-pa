...
in which 55 of the 97 capabilities are `available` and 42 — the six `documents.`
...
`42 of 97 capabilities are unwired.` Derived by building the manifest both ways
