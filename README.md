...
in which 53 of the 95 capabilities are `available` and 42 — the six `documents.`
...
`42 of 95 capabilities are unwired.` Derived by building the manifest both ways
