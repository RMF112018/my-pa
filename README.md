...
in which 72 of the 142 capabilities are `available` and 70 — the six `documents.`
...
`70 of 142 capabilities are unwired.` Derived by building the manifest both ways
