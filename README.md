...
in which 55 of the 101 capabilities are `available` and 46 — the six `documents.`
...
`46 of 101 capabilities are unwired.` Derived by building the manifest both ways
