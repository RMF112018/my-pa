...
in which 55 of the 125 capabilities are `available` and 70 — the six `documents.`
...
`70 of 125 capabilities are unwired.` Derived by building the manifest both ways
