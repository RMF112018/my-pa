...
in which 84 of the 154 capabilities are `available` and 70 — the six `documents.`
...
`70 of 154 capabilities are unwired.` Derived by building the manifest both ways
