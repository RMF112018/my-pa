...
in which 66 of the 136 capabilities are `available` and 70 — the six `documents.`
...
`70 of 136 capabilities are unwired.` Derived by building the manifest both ways
