...
in which 96 of the 166 capabilities are `available` and 70 — the six `documents.`
...
`70 of 166 capabilities are unwired.` Derived by building the manifest both ways
