...
in which 96 of the 172 capabilities are `available` and 76 — the six `documents.`
...
`76 of 172 capabilities are unwired.` Derived by building the manifest both ways
