...
in which 58 of the 127 capabilities are `available` and 69 — the six `documents.`
...
`69 of 127 capabilities are unwired.` Derived by building the manifest both ways
