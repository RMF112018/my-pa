...
`audit_events.capability` is constrained to the sixteen `Capability` values, so
recording a registration would mean a seventeenth member — which is exactly what
