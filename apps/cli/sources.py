...
`audit_events.capability` is constrained to the nineteen `Capability` values, so
recording a registration would mean a twentieth member — which is exactly what
