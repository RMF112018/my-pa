...
`audit_events.capability` is constrained to the thirteen `Capability` values, so
recording a registration would mean a fourteenth member — which is exactly what
