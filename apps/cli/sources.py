...
`audit_events.capability` is constrained to the fifteen `Capability` values, so
recording a registration would mean a sixteenth member — which is exactly what
