...
`audit_events.capability` is constrained to the twenty `Capability` values, so
recording a registration would mean a twenty-seventh member — which is exactly what
