...
`audit_events.capability` is constrained to the seventy-three `Capability` values,
so recording a registration would mean a seventy-fourth member — exactly what
