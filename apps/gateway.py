...
def build_parser() -> argparse.ArgumentParser:
    ...
    run = subcommands.add_parser("run", help="serve the sixty-five capabilities over HTTP")
    run.add_argument("--port", type=int, default=DEFAULT_PORT)

    subcommands.add_parser("mcp", help="serve the sixty-five capabilities over MCP on stdio")
