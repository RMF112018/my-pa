...
- [`ops/goodnotes/gsqs/README.md`](../ops/goodnotes/gsqs/README.md) — Gate B GSQS labeled semantic corpus, independent evaluator, and unused B0 harness. Operator review pending; `MEASURED_B0` is not established.
