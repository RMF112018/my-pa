...
- [`docs/specs/relationship-intelligence-v0.3.md`](specs/relationship-intelligence-v0.3.md) — mirror of the **controlling** Relationship Intelligence product specification (program-scale stakeholder/business-entity intelligence), current as of `AUDIT-MYPA-RELATIONSHIP-INTELLIGENCE-PR135-20260819-001`. Carries `RI-AC-001..040` verbatim; the current disposition against them is `docs/specs/relationship-intelligence-v0.3-acceptance.md`.
- [`docs/specs/relationship-intelligence-v0.2.md`](specs/relationship-intelligence-v0.2.md) — the predecessor Relationship Intelligence product specification, promoted into scope 2026-08-01. **Superseded lineage evidence**, not a current requirements source; see the notice at the top of the file.
