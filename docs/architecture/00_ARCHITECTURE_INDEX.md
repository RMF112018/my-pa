...
package defines one hundred and thirty-six capabilities and exposes them through the HTTP,
MCP, and operator-CLI adapters; a default composition serves sixty-six of
