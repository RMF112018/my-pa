...
package defines one hundred and sixty-four capabilities and exposes them through the HTTP,
MCP, and operator-CLI adapters; a default composition serves 94 of
