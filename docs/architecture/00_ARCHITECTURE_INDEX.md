...
Alembic owns seventy-eight revisions at head `b727e870d45e`; the chain admits GSQS at `c4b0a1d9e827` immediately before Phase B continues at `c7a1f04b9e63`, and `b727e870d45e` is additive on `8e1c4a7b2d90`. The current candidate
...
and further revisions have landed on top of it since, with current head `b727e870d45e` (corrected again 2026-08-29 from `8e1c4a7b2d90`, for the same reason and by the same derivation). The
