...
wires 166 through HTTP, MCP, and CLI composition, with PostgreSQL Principal
partitioning and two worker
planes. **A default composition exposes 96 of them.** The six
