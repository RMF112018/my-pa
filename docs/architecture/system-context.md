...
The `my_pa` application defines and wires one hundred and sixty-four capabilities through HTTP,
MCP, and CLI composition, with PostgreSQL Principal partitioning and two worker
planes. **A default composition exposes 94 of them.** The six
