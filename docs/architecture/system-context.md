...
The `my_pa` application defines and wires one hundred and thirty capabilities through HTTP,
MCP, and CLI composition, with PostgreSQL Principal partitioning and two worker
planes. **A default composition exposes sixty of them.** The six
