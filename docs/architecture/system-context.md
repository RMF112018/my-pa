...
The `my_pa` application defines and wires one hundred and forty-two capabilities through HTTP,
MCP, and CLI composition, with PostgreSQL Principal partitioning and two worker
planes. **A default composition exposes seventy-two of them.** The six
