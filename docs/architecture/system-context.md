...
The `my_pa` application defines and wires one hundred and fifty-four capabilities through HTTP,
MCP, and CLI composition, with PostgreSQL Principal partitioning and two worker
planes. **A default composition exposes eighty-four of them.** The six
