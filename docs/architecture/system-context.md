...
The `my_pa` application exposes fifty-six capabilities through HTTP, MCP, and
CLI composition, with PostgreSQL Principal partitioning and two worker planes.
Alembic owns fifty-nine revisions at head `e9b2c4d7a150`, including the merge of
