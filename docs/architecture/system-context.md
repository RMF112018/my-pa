...
The `my_pa` application defines and wires one hundred and sixty-three capabilities through HTTP,
MCP, and CLI composition, with PostgreSQL Principal partitioning and two worker
planes. **A default composition exposes 93 of them.** The six
