...
The `my_pa` application defines and wires one hundred and twelve capabilities through HTTP,
...
forty-two `entities.` names require `MY_PA_RELATIONSHIP_INTELLIGENCE_ENABLED`
(and its twenty-six writes a second switch beside it), and the
