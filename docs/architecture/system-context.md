...
The `my_pa` application defines and wires one hundred and nine capabilities through HTTP,
...
thirty-nine `entities.` names require `MY_PA_RELATIONSHIP_INTELLIGENCE_ENABLED`
