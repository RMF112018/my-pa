...
The `my_pa` application defines and wires one hundred and fifteen capabilities through HTTP,
...
forty-five `entities.` names require `MY_PA_RELATIONSHIP_INTELLIGENCE_ENABLED`
(and its twenty-nine writes a second switch beside it), and the
