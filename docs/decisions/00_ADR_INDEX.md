...
| [ADR-008](ADR-008-nas-runtime-topology.md) | NAS runtime topology and authority boundaries; its Entra production-browser authentication selection is superseded by ADR-011; its production public-browser ingress selection is superseded by ADR-012 | Accepted; browser-authentication selection partially superseded by ADR-011; public browser ingress superseded by ADR-012 |
