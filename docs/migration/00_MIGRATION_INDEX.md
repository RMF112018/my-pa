...
| Alembic revision | `6c4d3ea82f10` — the canonical database's revision, and the head of the migration chain. The repository head is now `8b3f5c17d904`; the two `knowledge` revisions above it run only against disposable databases and have never been applied here. |
