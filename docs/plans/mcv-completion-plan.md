...
| Alembic head | `3d07af4dc513` in the repository, seventy-five revisions; local validation targets disposable databases only | `migrations/versions/*.py`, `alembic heads` |
...
Two hundred and ninety Python modules under `src/my_pa` and three hundred and eighty-six test modules —
