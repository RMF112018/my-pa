...
| Alembic head | `e4d7b2f9a316` in the repository, sixty-three revisions; local validation targets disposable databases only | `migrations/versions/*.py`, `alembic heads` |
...
Two hundred and thirty-six Python modules under `src/my_pa` and two hundred and ninety-three test modules —
