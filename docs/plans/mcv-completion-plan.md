...
| Alembic head | `d4a8c1e7b930` in the repository, forty-eight revisions; local validation targets disposable databases only | `migrations/versions/*.py`, `alembic heads` |
...
Two hundred and seven Python modules under `src/my_pa` and two hundred and forty test modules —
