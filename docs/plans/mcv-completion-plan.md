...
| Alembic head | `d2b8f5c04e71` in the repository, sixty-two revisions; local validation targets disposable databases only | `migrations/versions/*.py`, `alembic heads` |
...
Two hundred and thirty-six Python modules under `src/my_pa` and two hundred and eighty-eight test modules —
