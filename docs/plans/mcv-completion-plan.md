...
| Alembic head | `823e23b6cc63` in the repository, sixty-nine revisions; local validation targets disposable databases only | `migrations/versions/*.py`, `alembic heads` |
...
Two hundred and eighty-four Python modules under `src/my_pa` and three hundred and sixty-three test modules —
