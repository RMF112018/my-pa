...
| Alembic head | `3d07af4dc513` in the repository, seventy-six revisions; the chain admits GSQS at `c4b0a1d9e827` immediately before Phase B continues at `c7a1f04b9e63`; local validation targets disposable databases only | `migrations/versions/*.py`, `alembic heads` |
...
Two hundred and ninety-nine Python modules under `src/my_pa` and three hundred and ninety-five test modules —
