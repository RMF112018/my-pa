...
| Alembic head | `b64e29a0f7c1` in the repository, seventy-four revisions; local validation targets disposable databases only | `migrations/versions/*.py`, `alembic heads` |
...
Two hundred and seventy-seven Python modules under `src/my_pa` and three hundred and sixty-three test modules —
