...
| Alembic head | `4f6a9c2d8e17` in the repository, thirty-eight revisions; local validation targets disposable databases only | `migrations/versions/*.py`, `alembic heads` |
...
One hundred and eighty-one Python modules under `src/my_pa` and two hundred and fifteen test modules —
...
| Alembic revisions — schemas and extensions, target tables, control plane, indexes, foreign keys, views, `knowledge` schema, extraction tables, audit events, enrolled objects, continuity, native sources, managed documents, GoodNotes and operations | Implemented, thirty-eight revisions, head `4f6a9c2d8e17` |
