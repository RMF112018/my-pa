...
| Alembic head | `f1c6b904a2d7` in the repository, sixty-seven revisions; local validation targets disposable databases only | `migrations/versions/*.py`, `alembic heads` |
...
Two hundred and sixty-seven Python modules under `src/my_pa` and three hundred and twenty-seven test modules —
