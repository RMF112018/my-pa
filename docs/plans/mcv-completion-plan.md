...
| Alembic head | `8e1c4a7b2d90` in the repository, seventy-seven revisions; the chain admits GSQS at `c4b0a1d9e827` immediately before Phase B continues at `c7a1f04b9e63`; local validation targets disposable databases only | `migrations/versions/*.py`, `alembic heads` |
...
Three hundred and four Python modules under `src/my_pa` and three hundred and ninety-nine test modules —
