...
**Current remeasurement (2026-09-22, exact head `70e300f3a97ca4f6981832c0f0ef21dcdfc0a78e`):** the two stated commands derive 352 source modules and 576 test modules from this tree. The dated provenance that follows is historical evidence for its respective trees and is not rewritten by this current count.
