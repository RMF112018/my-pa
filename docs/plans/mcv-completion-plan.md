...
**Current remeasurement (2026-09-22, exact head `7c8851fd18dbc50593bf63b43bacfe64f9e14959`):** the two stated commands derive 352 source modules and 575 test modules from this tree. The dated provenance that follows is historical evidence for its respective trees and is not rewritten by this current count.
