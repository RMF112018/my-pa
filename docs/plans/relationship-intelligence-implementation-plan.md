...
| Types | `mypy` (configured targets: `src`, `migrations`, `apps`, `ops`) — clean over 417 files. Re-derived on the Phase B plus GSQS merge candidate from the configured target tree. |
