...
| Claim | Evidence |
|---|---|
| FAST tier green | `pytest -m "not slow and not database and not network and not connector and not evaluation and not e2e and not recovery"` — **8066 passed, 0 failed, 961 deselected**. Architecture tier **3570 passed** |
