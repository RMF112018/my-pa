...
| [`relationship-memory-v0.1.md`](relationship-memory-v0.1.md) | **Implemented** — repository-native contract for the Relationship Memory plane, describing what the code does rather than what a package proposes. Composed off by default. |
