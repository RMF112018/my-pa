...
Generated 2026-08-01T15:47:35+00:00. Every number below was recomputed from the legacy
...
| P10-14 | the evidence tree passes the personal-data redaction scan (OD-004) | PASS | — | 0 findings over 68 files |
...
The scan covers `evidence`, `docs/migration`, including this
...
Files scanned: 68. Non-text files skipped: 0.
...
|---|---|---|---|---|---|
| `accepted_commitments` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `accepted_tasks` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `action_items` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `aging_exposure_report_items` | financial | SCHEMA_AND_DATA | 1,780 | 1,780 | 0 |
| `assistant_answer_draft_citations` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_answer_draft_events` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_answer_draft_receipts` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_answer_draft_sections` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_answer_drafts` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_context_pack_events` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_context_pack_items` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_context_pack_receipts` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_context_packs` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_intelligence_projection_events` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_intelligence_projection_items` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_intelligence_projection_receipts` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_intelligence_projections` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_memory_compilations` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_research_packet_citations` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_research_packet_events` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_research_packet_items` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_research_packet_receipts` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_research_packets` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `assistant_runs` | core | SCHEMA_AND_DATA | 106 | 106 | 0 |
| `attachments` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `brief_effectiveness_rollups` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `calendar_event_attendees` | calendar | SCHEMA_AND_DATA | 22,170 | 22,170 | 0 |
| `calendar_event_index` | calendar | SCHEMA_AND_DATA | 1,711 | 1,711 | 0 |
| `calendar_event_raw_content` | calendar | SCHEMA_AND_DATA | 1,709 | 1,709 | 0 |
| `calendar_project_match_candidates` | calendar | SCHEMA_AND_DATA_REBUILDABLE | 21 | 21 | 0 |
| `calendar_raw_event_attendees_structured` | calendar | SCHEMA_AND_DATA_REBUILDABLE | 22,137 | 22,137 | 0 |
| `calendar_raw_event_locations_structured` | calendar | SCHEMA_AND_DATA_REBUILDABLE | 1,416 | 1,416 | 0 |
| `calendar_raw_event_structured` | calendar | SCHEMA_AND_DATA_REBUILDABLE | 1,709 | 1,709 | 0 |
| `calendar_source_locations` | calendar | SCHEMA_AND_DATA | 1 | 1 | 0 |
| `candidate_merge_links` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `candidate_source_refs` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `claude_context_packet_items` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `claude_context_packets` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `commitment_candidates` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `construction_document_cards` | construction | SCHEMA_AND_DATA | 283 | 283 | 0 |
| `construction_document_classification_candidates` | construction | SCHEMA_AND_DATA_REBUILDABLE | 283 | 283 | 0 |
| `construction_document_intelligence_previews` | construction | SCHEMA_AND_DATA_REBUILDABLE | 1 | 1 | 0 |
| `construction_document_project_match_candidates` | construction | SCHEMA_AND_DATA_REBUILDABLE | 283 | 283 | 0 |
| `construction_document_relationship_candidates` | construction | SCHEMA_AND_DATA_REBUILDABLE | 23 | 23 | 0 |
| `construction_drive_item_inventory` | construction | SCHEMA_AND_DATA | 401 | 401 | 0 |
| `construction_drive_items` | construction | SCHEMA_AND_DATA | 1,000 | 1,000 | 0 |
| `construction_file_extraction_runs` | construction | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `construction_project_identity` | construction | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `construction_project_keyword_registry` | construction | PROVENANCE_ONLY | 0 | 0 | 0 |
| `construction_project_source_matches` | construction | PROVENANCE_ONLY | 0 | 0 | 0 |
| `construction_source_locations` | construction | SCHEMA_AND_DATA | 15 | 15 | 0 |
| `construction_source_resolutions` | construction | PROVENANCE_ONLY | 0 | 0 | 0 |
| `content_embeddings` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `cross_domain_context_readiness_mart` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `cross_source_intelligence_obsidian_runs` | core | SCHEMA_AND_DATA_REBUILDABLE | 1 | 1 | 0 |
| `cross_source_relationship_candidates` | core | SCHEMA_AND_DATA | 1,880 | 1,880 | 0 |
| `cross_source_relationships` | core | SCHEMA_AND_DATA | 1,671 | 1,671 | 0 |
| `daily_brief_action_candidates` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `daily_brief_assembly_runs` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `daily_brief_assembly_sections` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `daily_brief_change_event_refs` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `daily_brief_change_events` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `daily_brief_delivery_receipts` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `daily_brief_exposure_events` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `daily_brief_handoff_lines` | core | SCHEMA_AND_DATA_REBUILDABLE | 6,107 | 6,107 | 0 |
| `daily_brief_html_render_receipts` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `daily_brief_item_outcome_events` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `daily_brief_notification_receipts` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `daily_brief_open_receipts` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `daily_brief_ranked_candidates` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `daily_brief_ranking_runs` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `daily_brief_runs` | core | SCHEMA_AND_DATA_REBUILDABLE | 15 | 15 | 0 |
| `daily_brief_source_refs` | core | SCHEMA_AND_DATA_REBUILDABLE | 6,120 | 6,120 | 0 |
| `data_quality_gate_results` | core | SCHEMA_AND_DATA | 1,320 | 1,320 | 0 |
| `email_calendar_projection_coverage` | email | SCHEMA_AND_DATA | 120 | 120 | 0 |
| `email_followup_enrichments` | email | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `email_intelligence_active_policy` | email | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `email_message_attachments` | email | SCHEMA_AND_DATA | 16,352 | 16,352 | 0 |
| `email_message_body_vault_refs` | email | SCHEMA_AND_DATA | 5 | 5 | 0 |
| `email_message_raw_content` | email | SCHEMA_AND_DATA | 23,729 | 23,729 | 0 |
| `email_message_recipients` | email | SCHEMA_AND_DATA | 129,616 | 129,616 | 0 |
| `email_messages` | email | SCHEMA_AND_DATA | 23,733 | 23,733 | 0 |
| `email_model_classifications` | email | SCHEMA_AND_DATA_REBUILDABLE | 40 | 40 | 0 |
| `email_project_matches` | email | SCHEMA_AND_DATA_REBUILDABLE | 453 | 453 | 0 |
| `email_raw_message_attachments_structured` | email | SCHEMA_AND_DATA_REBUILDABLE | 4,676 | 4,676 | 0 |
| `email_raw_message_recipients_structured` | email | SCHEMA_AND_DATA_REBUILDABLE | 129,625 | 129,625 | 0 |
| `email_raw_message_structured` | email | SCHEMA_AND_DATA_REBUILDABLE | 23,729 | 23,729 | 0 |
| `email_raw_thread_messages_structured` | email | SCHEMA_AND_DATA_REBUILDABLE | 14,640 | 14,640 | 0 |
| `email_raw_thread_structured` | email | SCHEMA_AND_DATA_REBUILDABLE | 8,929 | 8,929 | 0 |
| `email_relationship_candidates` | email | SCHEMA_AND_DATA_REBUILDABLE | 6,569 | 6,569 | 0 |
| `email_source_locations` | email | SCHEMA_AND_DATA | 6 | 6 | 0 |
| `email_thread_raw_context` | email | SCHEMA_AND_DATA | 8,929 | 8,929 | 0 |
| `email_thread_summaries` | email | SCHEMA_AND_DATA_REBUILDABLE | 281 | 281 | 0 |
| `files` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `follow_up_status_events` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `follow_up_watch_items` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_accuracy_results` | financial | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `forecast_anomaly_findings` | financial | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `forecast_budget_details` | financial | SCHEMA_AND_DATA | 127 | 127 | 0 |
| `forecast_calibration_weights` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_comparison_results` | financial | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `forecast_confidence_factors` | financial | SCHEMA_AND_DATA_REBUILDABLE | 131 | 131 | 0 |
| `forecast_confidence_scorecards` | financial | SCHEMA_AND_DATA_REBUILDABLE | 128 | 128 | 0 |
| `forecast_config_items` | financial | SCHEMA_AND_DATA | 195 | 195 | 0 |
| `forecast_config_snapshot_items` | financial | SCHEMA_AND_DATA | 388 | 388 | 0 |
| `forecast_config_snapshots` | financial | SCHEMA_AND_DATA | 2 | 2 | 0 |
| `forecast_config_sources` | financial | SCHEMA_AND_DATA | 7 | 7 | 0 |
| `forecast_cost_entries` | financial | SCHEMA_AND_DATA | 6,324 | 6,324 | 0 |
| `forecast_cost_entry_staffing_actuals` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_data_availability_profiles` | financial | SCHEMA_AND_DATA | 7 | 7 | 0 |
| `forecast_evidence_packages` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_external_forecast_mappings` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_external_forecast_rows` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_external_forecasts` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_method_eligibility` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_model_selection_decisions` | financial | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `forecast_model_versions` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_monthly_actuals_by_budget_code` | financial | SCHEMA_AND_DATA | 1,081 | 1,081 | 0 |
| `forecast_operator_assumptions` | financial | SCHEMA_AND_DATA | 1 | 1 | 0 |
| `forecast_output_budget_codes` | financial | SCHEMA_AND_DATA_REBUILDABLE | 254 | 254 | 0 |
| `forecast_output_changes` | financial | SCHEMA_AND_DATA_REBUILDABLE | 49 | 49 | 0 |
| `forecast_output_commitment_exposure` | financial | SCHEMA_AND_DATA_REBUILDABLE | 127 | 127 | 0 |
| `forecast_output_monthly` | financial | SCHEMA_AND_DATA_REBUILDABLE | 2,932 | 2,932 | 0 |
| `forecast_output_monthly_table_rows` | financial | SCHEMA_AND_DATA_REBUILDABLE | 127 | 127 | 0 |
| `forecast_output_monthly_table_totals` | financial | SCHEMA_AND_DATA_REBUILDABLE | 1 | 1 | 0 |
| `forecast_output_narratives` | financial | SCHEMA_AND_DATA_REBUILDABLE | 127 | 127 | 0 |
| `forecast_output_probability` | financial | SCHEMA_AND_DATA_REBUILDABLE | 127 | 127 | 0 |
| `forecast_output_risks` | financial | SCHEMA_AND_DATA_REBUILDABLE | 155 | 155 | 0 |
| `forecast_output_schedule_phasing` | financial | SCHEMA_AND_DATA_REBUILDABLE | 58 | 58 | 0 |
| `forecast_output_staffing` | financial | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `forecast_outputs` | financial | SCHEMA_AND_DATA_REBUILDABLE | 2 | 2 | 0 |
| `forecast_package_manifests` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_project_maturity_snapshots` | financial | SCHEMA_AND_DATA | 1 | 1 | 0 |
| `forecast_project_staffing_absence_overrides` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_project_staffing_assumptions` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_project_staffing_attribution_review_items` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_project_staffing_attribution_rules` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_project_staffing_config` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_project_staffing_snapshot_rows` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_project_staffing_snapshots` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_projects` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_required_assumptions` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_review_items` | financial | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `forecast_runs` | financial | SCHEMA_AND_DATA | 10 | 10 | 0 |
| `forecast_staffing_cost_codes` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_staffing_template_versions` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `forecast_staffing_templates` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `long_term_memory_items` | core | SCHEMA_AND_DATA | 1 | 1 | 0 |
| `long_term_memory_quality_signals` | core | SCHEMA_AND_DATA | 2 | 2 | 0 |
| `long_term_memory_source_refs` | core | SCHEMA_AND_DATA | 1 | 1 | 0 |
| `meeting_email_relationship_candidates` | core | SCHEMA_AND_DATA_REBUILDABLE | 1,059 | 1,059 | 0 |
| `meeting_prep_brief_runs` | core | SCHEMA_AND_DATA_REBUILDABLE | 1 | 1 | 0 |
| `meeting_prep_brief_sections` | core | SCHEMA_AND_DATA_REBUILDABLE | 8 | 8 | 0 |
| `memory_update_candidates` | core | SCHEMA_AND_DATA | 2 | 2 | 0 |
| `memory_update_reviews` | core | SCHEMA_AND_DATA | 1 | 1 | 0 |
| `obsidian_index_entries` | core | SCHEMA_AND_DATA_REBUILDABLE | 5 | 5 | 0 |
| `obsidian_index_manifests` | core | SCHEMA_AND_DATA_REBUILDABLE | 7 | 7 | 0 |
| `obsidian_managed_section_registry` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `obsidian_note_index` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `obsidian_note_tag_index` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `obsidian_note_update_receipts` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `parser_outputs` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `phase10_relationship_candidates` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `procore_action_signals` | procore | SCHEMA_AND_DATA_REBUILDABLE | 20,788 | 20,788 | 0 |
| `procore_attachment_refs` | procore | SCHEMA_AND_DATA | 9,329 | 9,329 | 0 |
| `procore_company_entities` | procore | SCHEMA_AND_DATA | 241 | 241 | 0 |
| `procore_custom_field_values` | procore | SCHEMA_AND_DATA_REBUILDABLE | 9,320 | 9,320 | 0 |
| `procore_endpoint_raw_payloads` | procore | SCHEMA_AND_DATA | 145,193 | 145,193 | 0 |
| `procore_ep_billing_periods` | procore | SCHEMA_AND_DATA | 66 | 66 | 0 |
| `procore_ep_budget_change_history` | procore | SCHEMA_AND_DATA | 420 | 420 | 0 |
| `procore_ep_budget_detail_columns` | procore | SCHEMA_AND_DATA | 399 | 399 | 0 |
| `procore_ep_budget_detail_row_cells` | procore | SCHEMA_AND_DATA | 273,951 | 273,951 | 0 |
| `procore_ep_budget_detail_rows` | procore | SCHEMA_AND_DATA | 3,044 | 3,044 | 0 |
| `procore_ep_budget_modifications` | procore | SCHEMA_AND_DATA | 805 | 805 | 0 |
| `procore_ep_budget_views` | procore | SCHEMA_AND_DATA | 35 | 35 | 0 |
| `procore_ep_change_events` | procore | SCHEMA_AND_DATA | 1,104 | 1,104 | 0 |
| `procore_ep_change_events_attachments` | procore | SCHEMA_AND_DATA | 2,453 | 2,453 | 0 |
| `procore_ep_change_events_change_items` | procore | SCHEMA_AND_DATA | 2,966 | 2,966 | 0 |
| `procore_ep_change_events_change_items_budget_code_seg_2dff22` | procore | SCHEMA_AND_DATA | 8,898 | 8,898 | 0 |
| `procore_ep_change_events_markup_items` | procore | SCHEMA_AND_DATA | 2,232 | 2,232 | 0 |
| `procore_ep_change_events_markup_items_wbs_code_segment_items` | procore | SCHEMA_AND_DATA | 6,696 | 6,696 | 0 |
| `procore_ep_commitment_attachments` | procore | SCHEMA_AND_DATA | 153 | 153 | 0 |
| `procore_ep_commitment_change_orders` | procore | SCHEMA_AND_DATA | 288 | 288 | 0 |
| `procore_ep_commitment_compliance` | procore | SCHEMA_AND_DATA | 118 | 118 | 0 |
| `procore_ep_commitment_compliance_insurance_documents` | procore | SCHEMA_AND_DATA | 1,085 | 1,085 | 0 |
| `procore_ep_commitment_compliance_insurance_documents__52b7bf` | procore | SCHEMA_AND_DATA | 2,844 | 2,844 | 0 |
| `procore_ep_commitment_contracts` | procore | SCHEMA_AND_DATA | 248 | 248 | 0 |
| `procore_ep_commitment_line_items` | procore | SCHEMA_AND_DATA | 1,308 | 1,308 | 0 |
| `procore_ep_daily_log_dcrs` | procore | SCHEMA_AND_DATA | 2,976 | 2,976 | 0 |
| `procore_ep_daily_log_dcrs_attachments` | procore | SCHEMA_AND_DATA | 1,456 | 1,456 | 0 |
| `procore_ep_daily_log_deliveries` | procore | SCHEMA_AND_DATA | 60 | 60 | 0 |
| `procore_ep_daily_log_deliveries_attachments` | procore | SCHEMA_AND_DATA | 18 | 18 | 0 |
| `procore_ep_daily_log_inspections` | procore | SCHEMA_AND_DATA | 116 | 116 | 0 |
| `procore_ep_daily_log_inspections_attachments` | procore | SCHEMA_AND_DATA | 14 | 14 | 0 |
| `procore_ep_daily_log_manpower` | procore | SCHEMA_AND_DATA | 980 | 980 | 0 |
| `procore_ep_daily_log_manpower_attachments` | procore | SCHEMA_AND_DATA | 841 | 841 | 0 |
| `procore_ep_daily_log_notes` | procore | SCHEMA_AND_DATA | 93 | 93 | 0 |
| `procore_ep_daily_log_notes_attachments` | procore | SCHEMA_AND_DATA | 1,188 | 1,188 | 0 |
| `procore_ep_daily_log_visitor` | procore | SCHEMA_AND_DATA | 3 | 3 | 0 |
| `procore_ep_daily_log_weather` | procore | SCHEMA_AND_DATA | 208 | 208 | 0 |
| `procore_ep_inspection_items` | procore | SCHEMA_AND_DATA | 5,139 | 5,139 | 0 |
| `procore_ep_inspection_items_response_set_responses` | procore | SCHEMA_AND_DATA | 15,378 | 15,378 | 0 |
| `procore_ep_inspection_sections` | procore | SCHEMA_AND_DATA | 288 | 288 | 0 |
| `procore_ep_inspections` | procore | SCHEMA_AND_DATA | 208 | 208 | 0 |
| `procore_ep_inspections_attachments` | procore | SCHEMA_AND_DATA | 1,184 | 1,184 | 0 |
| `procore_ep_inspections_distribution_members` | procore | SCHEMA_AND_DATA | 827 | 827 | 0 |
| `procore_ep_inspections_inspectors` | procore | SCHEMA_AND_DATA | 237 | 237 | 0 |
| `procore_ep_inspections_signature_requests` | procore | SCHEMA_AND_DATA | 9 | 9 | 0 |
| `procore_ep_meetings` | procore | SCHEMA_AND_DATA | 576 | 576 | 0 |
| `procore_ep_observations` | procore | SCHEMA_AND_DATA | 1,491 | 1,491 | 0 |
| `procore_ep_observations_assignees` | procore | SCHEMA_AND_DATA | 368 | 368 | 0 |
| `procore_ep_prime_change_order_line_items` | procore | SCHEMA_AND_DATA | 249 | 249 | 0 |
| `procore_ep_prime_change_orders` | procore | SCHEMA_AND_DATA | 219 | 219 | 0 |
| `procore_ep_prime_contract_line_items` | procore | SCHEMA_AND_DATA | 499 | 499 | 0 |
| `procore_ep_prime_contracts` | procore | SCHEMA_AND_DATA | 7 | 7 | 0 |
| `procore_ep_projects` | procore | SCHEMA_AND_DATA | 6 | 6 | 0 |
| `procore_ep_projects_custom_fields_custom_field_163287_value` | procore | SCHEMA_AND_DATA | 1 | 1 | 0 |
| `procore_ep_projects_custom_fields_custom_field_163290_value` | procore | SCHEMA_AND_DATA | 1 | 1 | 0 |
| `procore_ep_projects_custom_fields_custom_field_163293_value` | procore | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `procore_ep_projects_custom_fields_custom_field_163296_value` | procore | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `procore_ep_projects_custom_fields_custom_field_163299_value` | procore | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `procore_ep_projects_custom_fields_custom_field_163302_value` | procore | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `procore_ep_punch_items` | procore | SCHEMA_AND_DATA | 36 | 36 | 0 |
| `procore_ep_punch_items_assignees` | procore | SCHEMA_AND_DATA | 48 | 48 | 0 |
| `procore_ep_punch_items_assignments` | procore | SCHEMA_AND_DATA | 48 | 48 | 0 |
| `procore_ep_punch_items_ball_in_court` | procore | SCHEMA_AND_DATA | 23 | 23 | 0 |
| `procore_ep_purchase_order_contracts` | procore | SCHEMA_AND_DATA | 11 | 11 | 0 |
| `procore_ep_purchase_order_contracts_custom_fields_cus_a0fe65` | procore | SCHEMA_AND_DATA | 1 | 1 | 0 |
| `procore_ep_purchase_order_line_items` | procore | SCHEMA_AND_DATA | 28 | 28 | 0 |
| `procore_ep_purchase_order_line_items_cost_code_line_i_779dbd` | procore | SCHEMA_AND_DATA | 49 | 49 | 0 |
| `procore_ep_rfis` | procore | SCHEMA_AND_DATA | 2,027 | 2,027 | 0 |
| `procore_ep_rfis_assignees` | procore | SCHEMA_AND_DATA | 3,500 | 3,500 | 0 |
| `procore_ep_rfis_ball_in_courts` | procore | SCHEMA_AND_DATA | 132 | 132 | 0 |
| `procore_ep_rfis_questions` | procore | SCHEMA_AND_DATA | 2,027 | 2,027 | 0 |
| `procore_ep_rfqs` | procore | SCHEMA_AND_DATA | 12 | 12 | 0 |
| `procore_ep_rfqs_attachments` | procore | SCHEMA_AND_DATA | 72 | 72 | 0 |
| `procore_ep_rfqs_change_event_attachments` | procore | SCHEMA_AND_DATA | 94 | 94 | 0 |
| `procore_ep_rfqs_change_event_change_event_line_items` | procore | SCHEMA_AND_DATA | 63 | 63 | 0 |
| `procore_ep_rfqs_change_event_change_event_line_items__0a3e8d` | procore | SCHEMA_AND_DATA | 69 | 69 | 0 |
| `procore_ep_schedule_activities` | procore | SCHEMA_AND_DATA | 18,909 | 18,909 | 0 |
| `procore_ep_schedule_activity_code_assignments` | procore | SCHEMA_AND_DATA | 63,970 | 63,970 | 0 |
| `procore_ep_schedule_calendars` | procore | SCHEMA_AND_DATA | 35 | 35 | 0 |
| `procore_ep_schedule_relationships` | procore | SCHEMA_AND_DATA | 44,570 | 44,570 | 0 |
| `procore_ep_schedule_udf_values` | procore | SCHEMA_AND_DATA | 39,407 | 39,407 | 0 |
| `procore_ep_schedule_wbs_nodes` | procore | SCHEMA_AND_DATA | 2,513 | 2,513 | 0 |
| `procore_ep_schedules` | procore | SCHEMA_AND_DATA | 30 | 30 | 0 |
| `procore_ep_subcontractor_invoice_change_order_items` | procore | SCHEMA_AND_DATA | 2,403 | 2,403 | 0 |
| `procore_ep_subcontractor_invoice_contract_detail_items` | procore | SCHEMA_AND_DATA | 51,428 | 51,428 | 0 |
| `procore_ep_subcontractor_invoices` | procore | SCHEMA_AND_DATA | 1,002 | 1,002 | 0 |
| `procore_ep_subcontractor_invoices_attachments` | procore | SCHEMA_AND_DATA | 1,000 | 1,000 | 0 |
| `procore_ep_submittals` | procore | SCHEMA_AND_DATA | 1,852 | 1,852 | 0 |
| `procore_ep_submittals_approvers` | procore | SCHEMA_AND_DATA | 7,601 | 7,601 | 0 |
| `procore_ep_submittals_approvers_attachments` | procore | SCHEMA_AND_DATA | 6,848 | 6,848 | 0 |
| `procore_ep_submittals_ball_in_court` | procore | SCHEMA_AND_DATA | 196 | 196 | 0 |
| `procore_financial_amount_facts` | procore | SCHEMA_AND_DATA_REBUILDABLE | 447,398 | 447,398 | 0 |
| `procore_financial_billing_periods` | procore | SCHEMA_AND_DATA_REBUILDABLE | 67 | 67 | 0 |
| `procore_financial_budget_changes` | procore | SCHEMA_AND_DATA_REBUILDABLE | 1,225 | 1,225 | 0 |
| `procore_financial_budget_rows` | procore | SCHEMA_AND_DATA_REBUILDABLE | 3,044 | 3,044 | 0 |
| `procore_financial_budget_views` | procore | SCHEMA_AND_DATA_REBUILDABLE | 35 | 35 | 0 |
| `procore_financial_change_events` | procore | SCHEMA_AND_DATA_REBUILDABLE | 1,106 | 1,106 | 0 |
| `procore_financial_change_order_line_items` | procore | SCHEMA_AND_DATA_REBUILDABLE | 944 | 944 | 0 |
| `procore_financial_change_orders` | procore | SCHEMA_AND_DATA_REBUILDABLE | 507 | 507 | 0 |
| `procore_financial_compliance_documents` | procore | SCHEMA_AND_DATA_REBUILDABLE | 1,588 | 1,588 | 0 |
| `procore_financial_contracts` | procore | SCHEMA_AND_DATA_REBUILDABLE | 271 | 271 | 0 |
| `procore_financial_invoice_items` | procore | SCHEMA_AND_DATA_REBUILDABLE | 71,113 | 71,113 | 0 |
| `procore_financial_line_items` | procore | SCHEMA_AND_DATA_REBUILDABLE | 2,110 | 2,110 | 0 |
| `procore_financial_rfqs` | procore | SCHEMA_AND_DATA_REBUILDABLE | 291 | 291 | 0 |
| `procore_financial_subcontractor_invoices` | procore | SCHEMA_AND_DATA_REBUILDABLE | 1,085 | 1,085 | 0 |
| `procore_inspection_evidence_rules` | procore | SCHEMA_AND_DATA_REBUILDABLE | 8,856 | 8,856 | 0 |
| `procore_inspection_items` | procore | SCHEMA_AND_DATA_REBUILDABLE | 8,856 | 8,856 | 0 |
| `procore_inspection_records` | procore | SCHEMA_AND_DATA_REBUILDABLE | 208 | 208 | 0 |
| `procore_inspection_response_options` | procore | SCHEMA_AND_DATA_REBUILDABLE | 33 | 33 | 0 |
| `procore_inspection_response_sets` | procore | SCHEMA_AND_DATA_REBUILDABLE | 11 | 11 | 0 |
| `procore_inspection_sections` | procore | SCHEMA_AND_DATA_REBUILDABLE | 288 | 288 | 0 |
| `procore_live_record_change_events` | procore | SCHEMA_AND_DATA | 111,663 | 111,663 | 0 |
| `procore_live_record_snapshots` | procore | SCHEMA_AND_DATA | 107,905 | 107,905 | 0 |
| `procore_live_record_state_index` | procore | SCHEMA_AND_DATA | 105,264 | 105,264 | 0 |
| `procore_live_records` | procore | SCHEMA_AND_DATA | 113,557 | 113,557 | 0 |
| `procore_live_sync_runs` | procore | SCHEMA_AND_DATA | 5,315 | 5,315 | 0 |
| `procore_location_entities` | procore | SCHEMA_AND_DATA | 165 | 165 | 0 |
| `procore_people_entities` | procore | SCHEMA_AND_DATA | 626 | 626 | 0 |
| `procore_raw_attachments` | procore | SCHEMA_AND_DATA | 240 | 240 | 0 |
| `procore_raw_budget_changes` | procore | SCHEMA_AND_DATA | 420 | 420 | 0 |
| `procore_raw_budget_columns` | procore | SCHEMA_AND_DATA | 399 | 399 | 0 |
| `procore_raw_budget_rows` | procore | SCHEMA_AND_DATA | 3,044 | 3,044 | 0 |
| `procore_raw_change_event_comments` | procore | SCHEMA_AND_DATA | 4 | 4 | 0 |
| `procore_raw_change_order_line_items` | procore | SCHEMA_AND_DATA | 944 | 944 | 0 |
| `procore_raw_change_orders` | procore | SCHEMA_AND_DATA | 507 | 507 | 0 |
| `procore_raw_contract_line_items` | procore | SCHEMA_AND_DATA | 2,110 | 2,110 | 0 |
| `procore_raw_contracts` | procore | SCHEMA_AND_DATA | 271 | 271 | 0 |
| `procore_raw_cost_code_dimensions` | procore | SCHEMA_AND_DATA | 679 | 679 | 0 |
| `procore_raw_daily_logs` | procore | SCHEMA_AND_DATA | 4,639 | 4,639 | 0 |
| `procore_raw_date_dimensions` | procore | SCHEMA_AND_DATA | 13,733 | 13,733 | 0 |
| `procore_raw_invoice_items` | procore | SCHEMA_AND_DATA | 71,113 | 71,113 | 0 |
| `procore_raw_invoices` | procore | SCHEMA_AND_DATA | 1,085 | 1,085 | 0 |
| `procore_raw_meeting_details` | procore | SCHEMA_AND_DATA | 576 | 576 | 0 |
| `procore_raw_meeting_topics` | procore | SCHEMA_AND_DATA | 8,169 | 8,169 | 0 |
| `procore_raw_project_dimensions` | procore | SCHEMA_AND_DATA | 48 | 48 | 0 |
| `procore_raw_rfi_responses` | procore | SCHEMA_AND_DATA | 123 | 123 | 0 |
| `procore_raw_rfq_responses` | procore | SCHEMA_AND_DATA | 315 | 315 | 0 |
| `procore_raw_status_dimensions` | procore | SCHEMA_AND_DATA | 227 | 227 | 0 |
| `procore_raw_submittal_packages` | procore | SCHEMA_AND_DATA | 11 | 11 | 0 |
| `procore_record_edges` | procore | SCHEMA_AND_DATA_REBUILDABLE | 101,479 | 101,479 | 0 |
| `procore_record_timeline_events` | procore | SCHEMA_AND_DATA_REBUILDABLE | 105,952 | 105,952 | 0 |
| `procore_synced_entities` | procore | SCHEMA_AND_DATA | 1,185 | 1,185 | 0 |
| `procore_text_intelligence` | procore | SCHEMA_AND_DATA_REBUILDABLE | 12,895 | 12,895 | 0 |
| `project_issue_history_items` | core | SCHEMA_AND_DATA | 598 | 598 | 0 |
| `project_risk_digest_items` | core | SCHEMA_AND_DATA | 44 | 44 | 0 |
| `project_schedule_baseline_selections` | schedule | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `project_schedule_named_baseline_slots` | schedule | SCHEMA_AND_DATA | 3 | 3 | 0 |
| `project_schedule_series_membership` | schedule | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `project_source_coverage_mart` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `ranking_policy_eval_items` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `ranking_policy_eval_runs` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `raw_content_access_events` | core | SCHEMA_AND_DATA | 39,839 | 39,839 | 0 |
| `relationship_quality_mart` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `retrieval_context_refs` | core | SCHEMA_AND_DATA | 6,528 | 6,528 | 0 |
| `retrieval_query_receipts` | core | SCHEMA_AND_DATA | 16 | 16 | 0 |
| `schedule_baseline_activities` | schedule | SCHEMA_AND_DATA | 15,818 | 15,818 | 0 |
| `schedule_baseline_activity_codes` | schedule | SCHEMA_AND_DATA | 31,250 | 31,250 | 0 |
| `schedule_baseline_activity_crosswalk` | schedule | SCHEMA_AND_DATA | 15,486 | 15,486 | 0 |
| `schedule_baseline_health_facts` | schedule | SCHEMA_AND_DATA_REBUILDABLE | 99 | 99 | 0 |
| `schedule_baseline_projects` | schedule | SCHEMA_AND_DATA | 11 | 11 | 0 |
| `schedule_baseline_relationships` | schedule | SCHEMA_AND_DATA | 37,044 | 37,044 | 0 |
| `schedule_baseline_udfs` | schedule | SCHEMA_AND_DATA | 17,693 | 17,693 | 0 |
| `schedule_baseline_wbs` | schedule | SCHEMA_AND_DATA | 1,862 | 1,862 | 0 |
| `schedule_cost_distributions` | schedule | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `schedule_cost_mapping_candidates` | schedule | SCHEMA_AND_DATA_REBUILDABLE | 2,607 | 2,607 | 0 |
| `schedule_cost_mapping_runs` | schedule | SCHEMA_AND_DATA | 3 | 3 | 0 |
| `schedule_cost_weighting_results` | schedule | SCHEMA_AND_DATA_REBUILDABLE | 37 | 37 | 0 |
| `schedule_cpm_activity_results` | schedule | SCHEMA_AND_DATA_REBUILDABLE | 18,084 | 18,084 | 0 |
| `schedule_cpm_diagnostics` | schedule | SCHEMA_AND_DATA | 24,462 | 24,462 | 0 |
| `schedule_cpm_path_activities` | schedule | SCHEMA_AND_DATA_REBUILDABLE | 91 | 91 | 0 |
| `schedule_cpm_paths` | schedule | SCHEMA_AND_DATA_REBUILDABLE | 3 | 3 | 0 |
| `schedule_cpm_relationship_results` | schedule | SCHEMA_AND_DATA_REBUILDABLE | 35,289 | 35,289 | 0 |
| `schedule_cpm_runs` | schedule | SCHEMA_AND_DATA | 18 | 18 | 0 |
| `schedule_file_imports` | schedule | SCHEMA_AND_DATA | 25 | 25 | 0 |
| `schedule_identities` | schedule | SCHEMA_AND_DATA | 4 | 4 | 0 |
| `schedule_identity_manual_actions` | schedule | SCHEMA_AND_DATA | 1 | 1 | 0 |
| `schedule_import_package_files` | schedule | SCHEMA_AND_DATA | 21 | 21 | 0 |
| `schedule_import_packages` | schedule | SCHEMA_AND_DATA | 12 | 12 | 0 |
| `schedule_package_equivalence_facts` | schedule | SCHEMA_AND_DATA | 8 | 8 | 0 |
| `schedule_package_field_lineage` | schedule | SCHEMA_AND_DATA | 144 | 144 | 0 |
| `schedule_quality_evaluation_runs` | schedule | SCHEMA_AND_DATA | 42 | 42 | 0 |
| `schedule_quality_findings` | schedule | SCHEMA_AND_DATA | 9,502 | 9,502 | 0 |
| `schedule_quality_metric_results` | schedule | SCHEMA_AND_DATA_REBUILDABLE | 450 | 450 | 0 |
| `schedule_quality_scorecards` | schedule | SCHEMA_AND_DATA | 42 | 42 | 0 |
| `schedule_source_capabilities` | schedule | SCHEMA_AND_DATA | 163 | 163 | 0 |
| `schedule_version_diff_detail_facts` | schedule | SCHEMA_AND_DATA_REBUILDABLE | 209,437 | 209,437 | 0 |
| `schedule_version_diff_facts` | schedule | SCHEMA_AND_DATA_REBUILDABLE | 160 | 160 | 0 |
| `schedule_version_diff_impact_rollups` | schedule | SCHEMA_AND_DATA_REBUILDABLE | 32,728 | 32,728 | 0 |
| `schedule_version_identity_matches` | schedule | SCHEMA_AND_DATA | 10 | 10 | 0 |
| `schema_migrations` | core | SCHEMA_AND_DATA | 128 | 128 | 0 |
| `second_brain_agent_model_receipts` | core | SCHEMA_AND_DATA | 15 | 15 | 0 |
| `second_brain_agent_run_receipts` | core | SCHEMA_AND_DATA | 15 | 15 | 0 |
| `second_brain_evaluation_runs` | core | SCHEMA_AND_DATA | 15 | 15 | 0 |
| `second_brain_financial_amount_facts_normalized` | financial | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `second_brain_financial_currency_completeness_snapshots` | financial | SCHEMA_AND_DATA | 291 | 291 | 0 |
| `second_brain_financial_exposure_summary_items` | financial | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `second_brain_financial_review_required_items` | financial | SCHEMA_AND_DATA | 128,769 | 128,769 | 0 |
| `second_brain_financial_source_coverage_snapshots` | financial | SCHEMA_AND_DATA | 980 | 980 | 0 |
| `second_brain_financial_wbs_cost_code_snapshots` | financial | SCHEMA_AND_DATA | 97 | 97 | 0 |
| `second_brain_mcp_claude_desktop_config_previews` | core | SCHEMA_AND_DATA | 2 | 2 | 0 |
| `second_brain_mcp_permission_audit_runs` | core | SCHEMA_AND_DATA | 3 | 3 | 0 |
| `second_brain_mcp_prompt_registry_snapshots` | core | SCHEMA_AND_DATA | 3 | 3 | 0 |
| `second_brain_mcp_resource_registry_snapshots` | core | SCHEMA_AND_DATA | 3 | 3 | 0 |
| `second_brain_mcp_server_config_snapshots` | core | SCHEMA_AND_DATA | 15 | 15 | 0 |
| `second_brain_mcp_tool_call_receipts` | core | SCHEMA_AND_DATA | 14 | 14 | 0 |
| `second_brain_mcp_tool_registry_snapshots` | core | SCHEMA_AND_DATA | 3 | 3 | 0 |
| `second_brain_research_packets` | core | SCHEMA_AND_DATA_REBUILDABLE | 2 | 2 | 0 |
| `second_brain_retrieval_approved_source_manifests` | core | SCHEMA_AND_DATA | 1 | 1 | 0 |
| `second_brain_retrieval_vector_index_items` | core | SCHEMA_AND_DATA | 6,805 | 6,805 | 0 |
| `second_brain_retrieval_vector_index_runs` | core | SCHEMA_AND_DATA | 5 | 5 | 0 |
| `second_brain_runtime_config_receipts` | core | SCHEMA_AND_DATA | 14 | 14 | 0 |
| `source_evidence_trails` | core | SCHEMA_AND_DATA | 1,880 | 1,880 | 0 |
| `source_index_entities` | core | SCHEMA_AND_DATA | 9,128 | 9,128 | 0 |
| `source_index_locators` | core | SCHEMA_AND_DATA | 9,128 | 9,128 | 0 |
| `source_index_move_signals` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `source_intelligence_chunks` | core | SCHEMA_AND_DATA | 2,926 | 2,920 | 6 |
| `source_intelligence_generated_notes` | core | SCHEMA_AND_DATA | 195 | 195 | 0 |
| `source_intelligence_metadata` | core | SCHEMA_AND_DATA | 9,128 | 9,128 | 0 |
| `source_intelligence_relationships` | core | SCHEMA_AND_DATA | 285 | 285 | 0 |
| `source_intelligence_sources` | core | SCHEMA_AND_DATA | 9,128 | 9,128 | 0 |
| `source_intelligence_summaries` | core | SCHEMA_AND_DATA | 7 | 7 | 0 |
| `source_intelligence_text` | core | SCHEMA_AND_DATA | 5,738 | 5,736 | 2 |
| `source_links` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `source_record_summary_mart` | core | SCHEMA_AND_DATA_REBUILDABLE | 0 | 0 | 0 |
| `source_records` | core | PROVENANCE_ONLY | 0 | 0 | 0 |
| `source_structure_entities` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `source_structure_entity_folders` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `source_structure_folders` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `source_structure_overrides` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `source_structure_roots` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `source_system_record_map` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `staffing_holiday_calendar_dates` | financial | SCHEMA_AND_DATA | 150 | 150 | 0 |
| `staffing_holiday_calendars` | financial | SCHEMA_AND_DATA | 1 | 1 | 0 |
| `sync_state` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
| `task_candidates` | core | SCHEMA_AND_DATA | 0 | 0 | 0 |
