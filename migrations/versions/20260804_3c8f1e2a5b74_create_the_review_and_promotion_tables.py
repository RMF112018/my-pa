...
def upgrade() -> None:
    ...
    op.execute(
        ...
        "                 ON r.assertion_id = a.assertion_id "
        "                AND r.decision_id = d.decision_id "
