...
| [`relationship-intelligence.md`](relationship-intelligence.md) | The entity plane: what its thirty-one `entities.` names answer, how to work the unresolved-mention and canonical proposal-review queues, how to read a resolution outcome, and how the plane, write, identity-correction, remote-write, exact `remote.operator`, durable capability/purpose, and policy gates compose around its ten reads and twenty-one writes. Split, final Relationship Memory redistribution, complete cross-plane re-enrichment, and live activation remain deferred. |
