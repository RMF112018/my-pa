...
| [`production-frontend-deployment.md`](production-frontend-deployment.md) | Public browser origin `pa.bobby-fetting.me`: gated smoke-upgrade checklist, the 2026-09-26 serving observation, and the 2026-09-24 deviations. Private or public `/api/health` does not prove the gateway migration probe or WebAuthn sign-in. |
