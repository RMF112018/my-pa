...
| [`relationship-intelligence.md`](relationship-intelligence.md) | The entity plane: what its five read capabilities answer, how to read the unresolved-mention and proposal queues, how to read a resolution outcome — and that the review queue **cannot be worked** in this build, because the governance service is composed by nothing. |
