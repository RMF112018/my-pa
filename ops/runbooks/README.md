...
| [`production-frontend-deployment.md`](production-frontend-deployment.md) | Public browser origin `pa.bobby-fetting.me`: prepare/safe sequence, operator-gated activate placeholders, rollback dry-run. **PRODUCTION_ACTIVATION_NOT_PERFORMED.** |
