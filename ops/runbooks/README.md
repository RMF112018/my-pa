...
| [`gateway-operations.md`](gateway-operations.md) | The HTTP gateway process: running it on loopback, calling the forty-seven capabilities, the status each error code takes, its two connection pools, and stopping it. |
