...
| [`relationship-intelligence.md`](relationship-intelligence.md) | The entity plane: what its fifty-one `entities.` names answer, including Principal-scoped identity history and governed merge/split preview/apply; how the plane, write, identity-correction, remote-write, exact `remote.operator`, durable capability/purpose, and policy gates compose around its sixteen reads and thirty-five writes; and the unexecuted, operator-gated WP-08 commissioning and WP-09 canary procedures. Live activation remains deferred. |
