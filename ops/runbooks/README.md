...
| [`relationship-intelligence.md`](relationship-intelligence.md) | The entity plane: what its twenty-eight `entities.` names answer, how to read the unresolved-mention and proposal queues, how to read a resolution outcome, how the two switches gate its ten reads and eighteen writes — and that the *proposal* review queue still **cannot be worked** in this build, because the merge half of the governance service is composed by nothing. |
