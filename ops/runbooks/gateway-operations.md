...
`apps/gateway.py` routes the one hundred and sixty-three public capabilities over HTTP on
loopback and, in a default process, serves seventy-two of them.
...
`70 of 136 capabilities are unwired.` rather than `ready`.
