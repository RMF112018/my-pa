...
`apps/gateway.py` routes the ninety-eight public capabilities over HTTP on
...
**Current-state correction (2026-08-23):** the candidate has **ninety-eight**
capabilities and **seventy-one** Alembic revisions at head `d8f3a1c6e942`.
