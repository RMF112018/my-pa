...
`apps/gateway.py` serves the forty-five public capabilities over HTTP on loopback.
...
**Current-state correction (2026-08-15):** the candidate has **forty-five**
capabilities and **forty-seven** Alembic revisions at head `b7c4e9a2d518`.
