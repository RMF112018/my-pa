...
`apps/gateway.py` routes the one hundred and nine public capabilities over HTTP on
...
`MY_PA_MANAGED_DOCUMENT_ROOT`, the thirty-nine `entities.` names behind
...
**Current-state correction (2026-08-28):** the candidate has **one hundred and nine**
