...
`apps/gateway.py` routes the one hundred and two public capabilities over HTTP on
loopback and, in a default process, serves fifty-six of them.
...
**Current-state correction (2026-08-23):** the candidate has **one hundred and two**
capabilities and **seventy-seven** Alembic revisions at head `d8f3a1c6e942`; the merged chain admits GSQS start/status at `c4b0a1d9e827` before continuing Phase B at `c7a1f04b9e63`, then `gsqs.step` after `3d07af4dc513`.
