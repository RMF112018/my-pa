...
`apps/gateway.py` routes the one hundred and thirty-six public capabilities over HTTP on
loopback and, in a default process, serves sixty-six of them.
