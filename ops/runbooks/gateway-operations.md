...
`apps/gateway.py` routes the one hundred and thirty public capabilities over HTTP on
loopback and, in a default process, serves sixty of them.
...
`70 of 130 capabilities are unwired.` rather than `ready`.
