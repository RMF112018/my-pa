...
`apps/gateway.py` routes the one hundred and twenty-seven public capabilities over HTTP on
...
`MY_PA_MANAGED_DOCUMENT_ROOT`, the fifty-four `entities.` names behind
...
`69 of 127 capabilities are unwired.` rather than `ready`.
