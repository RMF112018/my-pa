...
`apps/gateway.py` routes the one hundred and twenty-eight public capabilities over HTTP on
loopback and, in a default process, serves fifty-eight of them.
...
`69 of 128 capabilities are unwired.` rather than `ready`.
