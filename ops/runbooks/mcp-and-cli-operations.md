...
**96 application-available capabilities**: 172 less the six `documents.`,
...
`MY_PA_RELATIONSHIP_MEMORY_ENABLED`; a child publishing all one hundred and seventy-two has
