...
`tests/contract/test_transport_parity.py` holds it over all one hundred and nine capabilities.
...
**one hundred and nine** current capabilities, and the schema has
