...
`tests/contract/test_transport_parity.py` holds it over all twenty capabilities.
...
`tools/list` returns twenty tools whose names are the twenty capability names.
