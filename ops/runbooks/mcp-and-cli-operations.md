...
`tests/contract/test_transport_parity.py` holds it over all sixteen capabilities.
...
`tools/list` returns sixteen tools whose names are the sixteen capability names.
