...
`tests/contract/test_transport_parity.py` holds it over all nineteen capabilities.
...
`tools/list` returns nineteen tools whose names are the nineteen capability names.
