...
fields, the same for all twenty-nine capabilities — so it is presented as options,
...
already says, and a thirtieth capability would arrive with none. `--payload` is
