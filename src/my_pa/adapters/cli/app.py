...
fields, the same for all one hundred and two capabilities — so it is presented as
...
`application.commands` already says, and a one-hundred-third capability would
