...
fields, the same for all forty-eight capabilities — so it is presented as options,
...
already says, and a forty-ninth capability would arrive with none. `--payload` is
