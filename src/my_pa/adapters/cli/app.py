...
fields, the same for all twenty-six capabilities — so it is presented as options,
...
already says, and a twenty-seventh capability would arrive with none. `--payload` is
