...
fields, the same for all forty-seven capabilities — so it is presented as options,
...
already says, and a forty-eighth capability would arrive with none. `--payload` is
