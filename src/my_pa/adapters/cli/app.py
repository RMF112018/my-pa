...
fields, the same for all fifty-six capabilities — so it is presented as options,
...
already says, and a fifty-seventh capability would arrive with none. `--payload` is
