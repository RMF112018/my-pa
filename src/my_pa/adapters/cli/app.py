...
fields, the same for all fifty-four capabilities — so it is presented as options,
...
already says, and a fifty-fifth capability would arrive with none. `--payload` is
