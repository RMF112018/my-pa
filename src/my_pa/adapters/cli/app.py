...
fields, the same for all fifty-three capabilities — so it is presented as options,
...
already says, and a fifty-fourth capability would arrive with none. `--payload` is
