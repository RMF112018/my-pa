...
fields, the same for all thirty-one capabilities — so it is presented as options,
...
already says, and a thirty-second capability would arrive with none. `--payload` is
