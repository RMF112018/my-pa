...
class SafeDetail(StrEnum):
    ...
    #: Publish completeness. Field names only; `DUE_AT` (`due_at`) is not `due_date`.
    CONSTRAINT_PUBLISH_INCOMPLETE = "constraint_publish_incomplete"
    CATEGORY_ID = "category_id"
    DESCRIPTION = "description"
    DATE_IDENTIFIED = "date_identified"
    DUE_DATE = "due_date"
    BIC = "bic"
    CONSTRAINT_PUBLISH_CATEGORY_INACTIVE = "constraint_publish_category_not_active"
    CONSTRAINT_PUBLISH_QUALITY = "constraint_publish_quality_not_normal"
