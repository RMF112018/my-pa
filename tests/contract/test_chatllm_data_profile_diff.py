...
def test_default_plane_effective_target_is_eighty_one() -> None:
    composed = composed_capabilities(IMPLEMENTED, _DEFAULT_PLANES)
    desired = desired_effective_capabilities(composed)
    assert len(desired) == 81
