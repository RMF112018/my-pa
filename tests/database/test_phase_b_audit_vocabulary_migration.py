...
HEAD_REVISION: Final = "f5b06925857e"
...
def test_the_chain_reaches_this_head_and_holds_one(migrated_engine: Engine) -> None:
    ...
    # `f5b06925857e` (RI-ENT-WP-04) is additive on `441b071bf37b` (RI-ENT-WP-03),
    ...
    assert script.get_revision(HEAD_REVISION).down_revision == "441b071bf37b"
