...
def commands_for(scene: Scene) -> dict[Capability, Command]:
    ...
    return {
        ...
        Capability.TASKS_COMMENTS_LIST: ListTaskComments(task_id=issue_identifier(IdKind.TASK)),
        Capability.TASKS_COMMENTS_CREATE: CreateTaskComment(
            task_id=issue_identifier(IdKind.TASK),
            body="Denial-path comment",
            idempotency_key="denial-tasks-comments-create-0001",
        ),
        ...
        Capability.GOODNOTES_PAGES_LIST: ListGoodNotesPages(
            notebook_id=issue_stable_id("gnnb", "denial"),
        ),
        ...
        Capability.GOODNOTES_CORRECT: CorrectGoodNotes(
            occurrence_id=issue_stable_id("gnocc", "denial"),
        ...
        Capability.GSQS_START: StartGsqsB0(
            ...
            repetition=1,
            idempotency_key="denial-gsqs-start-0001",
        ),
        Capability.GSQS_STATUS: GetGsqsB0Status(run_id="b0run_" + "a" * 24),
