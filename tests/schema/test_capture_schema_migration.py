...
emits what it emitted on the day it merged, with one hundred and two capabilities and
...
CAPABILITIES_ADDED_AFTER_THE_CAPTURE_REVISION: Final[frozenset[str]] = frozenset(
    {
        ...
        # Connected-MCP B0 workflow. `c4b0a1d9e827` admitted start/status;
        # `d8f3a1c6e942` admits `gsqs.step` on `capability_is_known`.
        "gsqs.start",
        "gsqs.status",
        "gsqs.step",
    }
