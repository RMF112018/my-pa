...
Two revisions. `8a1c4e7b2d90` widens the audited vocabulary; `9b2d5f8c3e01` is
the current head and creates `knowledge.context_runs` / `context_run_items`.
...
def test_the_chain_has_one_head_and_these_revisions_are_in_order() -> None:
    ...
    assert list(script.get_heads()) == [TABLE_REVISION]
