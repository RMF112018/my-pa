...
KNOWLEDGE_TABLES_BY_REVISION: Final[dict[str, frozenset[str]]] = {
    ...
    # WP-TM-05: append-only mutation receipts. The table landed on main with the
    # Commitment/Task/Follow-Up revision; the structural guard must name it.
    ...
    "d7e1a4c8b926": frozenset({"goodnotes_semantic_proposals"}),
    "e8c1b5a7d204": frozenset({"goodnotes_entity_associations", "goodnotes_delivery_receipts"}),
    "c3e9a7f1b204": frozenset(),
    "a4d9c2e7b815": frozenset({"goodnotes_ingestion_run_stages", "goodnotes_page_rasters"}),
    ...
    "c1a8e4d70b29": frozenset({"capture_labels"}),
    "de5ec1c65857": frozenset({"task_comments"}),
}
