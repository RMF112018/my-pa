...
#:
#: Every one of the twenty-one keyed writes -- Phase A's eighteen plus
...
def test_every_entity_write_is_a_server_stamped_idempotent_remote_capability() -> None:
    ...
    # Twenty-one after `RI-ENT-WP-11`'s first record family: Phase A's eighteen
    # plus that family's three verbs, each of which carries its own key.
