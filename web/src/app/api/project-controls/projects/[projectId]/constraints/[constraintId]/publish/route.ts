/**
 * `POST …/constraints/[constraintId]/publish` — `constraints.publish`: publish a Draft, optionally naming its first active state (the backend
