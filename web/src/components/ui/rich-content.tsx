...
export function safeHref(href: string): string | null { try { const url = new URL(href, "https://local.invalid"); return ["http:", "https:", "mailto:"].includes(url.protocol) ? href : null; } catch { return null; } }
