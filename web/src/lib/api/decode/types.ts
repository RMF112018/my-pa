...
import type { ConstraintCategoriesListResult } from "./capabilities/constraint_categories.list";
...
import type { GoodNotesContentResult } from "./capabilities/goodnotes.content";
import type { GoodNotesCorrectResult } from "./capabilities/goodnotes.correct";
import type { GoodNotesNotebooksListResult } from "./capabilities/goodnotes.notebooks.list";
import type { GoodNotesPagesListResult } from "./capabilities/goodnotes.pages.list";
import type { GoodNotesReadResult } from "./capabilities/goodnotes.read";
...
export type CapabilityResults = {
  ...
  readonly "constraint_categories.list": ConstraintCategoriesListResult;
  ...
  readonly "goodnotes.content": GoodNotesContentResult;
  readonly "goodnotes.correct": GoodNotesCorrectResult;
  readonly "goodnotes.notebooks.list": GoodNotesNotebooksListResult;
  readonly "goodnotes.pages.list": GoodNotesPagesListResult;
  readonly "goodnotes.read": GoodNotesReadResult;
  readonly "goodnotes.runs.list": GoodNotesRunsListResult;
  readonly "goodnotes.search": GoodNotesSearchResult;
